...
<span class="plain_header"><img src="images/icons/stats.png" alt="Statistics" width="16" height="16" class="absmiddle" /> Statistics</span>
<div class="smallfont">
<a href="orders.php?filter=true&amp;status=Pending">Pending Orders</a>: {$sidebarstats.orders.pending}<br />
<br />
<a href="clients.php?status=Active">Active Clients</a>: {$sidebarstats.clients.active}<br />
<a href="clients.php?status=Inactive">Inactive Clients</a>: {$sidebarstats.clients.inactive}<br />
<a href="clients.php?status=Closed">Closed Clients</a>: {$sidebarstats.clients.closed}<br />
<br />
<a href="clientshostinglist.php?status=Pending">Pending Services</a>: {$sidebarstats.services.pending}<br />
<a href="clientshostinglist.php?status=Active">Active Services</a>: {$sidebarstats.services.active}<br />
<a href="clientshostinglist.php?status=Suspended">Suspended Services</a>: {$sidebarstats.services.suspended}<br />
<a href="clientshostinglist.php?status=Terminated">Terminated Services</a>: {$sidebarstats.services.terminated}<br />
<a href="clientshostinglist.php?status=Cancelled">Cancelled Services</a>: {$sidebarstats.services.cancelled}<br />
<a href="clientshostinglist.php?status=Fraud">Fraud Services</a>: {$sidebarstats.services.fraud}<br />
<br />
<a href="clientsdomainlist.php?status=Pending">Pending Domains</a>: {$sidebarstats.domains.pending}<br />
<a href="clientsdomainlist.php?status=Pending%20Transfer">Pending Transfer Domains</a>: {$sidebarstats.domains.pendingtransfer}<br />
<a href="clientsdomainlist.php?status=Active">Active Domains</a>: {$sidebarstats.domains.active}<br />
<a href="clientsdomainlist.php?status=Expired">Expired Domains</a>: {$sidebarstats.domains.expired}<br />
<a href="clientsdomainlist.php?status=Cancelled">Cancelled Domains</a>: {$sidebarstats.domains.cancelled}<br />
<a href="clientsdomainlist.php?status=Fraud">Fraud Domains</a>: {$sidebarstats.domains.fraud}<br />
<br />
...
<br />
<a href="supporttickets.php?view=active">Active Support Tickets</a>: {$sidebarstats.tickets.active}<br />
<a href="supporttickets.php?view=flagged">Active Flagged Tickets</a>: {$sidebarstats.tickets.flagged}
</div>
