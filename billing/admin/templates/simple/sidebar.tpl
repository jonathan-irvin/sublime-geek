...
<span class="header"><img src="images/icons/transactions.png" class="absmiddle" alt="Money" width="16" height="16" /> Income Projection</span>
<div align="center"><br />{$incomestats}</div>

<br />

<span class="header"><img src="images/icons/config.png" class="absmiddle" alt="Config" width="16" height="16" /> System Information</span>
<ul class="menu">
    <li>Reg. To: {$licenseinfo.registeredname}</li>
    <li>Type: {$licenseinfo.productname}</li>
    <li>Expires: {$licenseinfo.expires}</li>
    <li>Version: {$licenseinfo.currentversion}</li>
    {if $licenseinfo.currentversion neq $licenseinfo.latestversion}<li><span class="textred"><b>An update is available!</b></span></li>{/if}
</ul>
...
<span class="header"><img src="images/icons/linktracking.png" class="absmiddle" width="16" height="16" /> Quick Links</span>
<ul class="menu">
    <li><a href="orders.php?filter=true&amp;status=Pending">Pending Orders ({$sidebarstats.orders.pending})</a></li>
    <li><a href="clients.php?status=Active">Active Clients ({$sidebarstats.clients.active})</a></li>
    <li><a href="clientshostinglist.php?status=Active">Active Services ({$sidebarstats.services.active})</a></li>
    <li><a href="clientsdomainlist.php?status=Active">Active Domains ({$sidebarstats.domains.active})</a></li>
    <li><a href="invoices.php?status=Overdue">Overdue Invoices ({$sidebarstats.invoices.overdue})</a></li>
    <li><a href="supporttickets.php">Tickets Awaiting Reply ({$sidebarstats.tickets.awaitingreply})</a></li>
</ul>
