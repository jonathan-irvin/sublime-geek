    ...
    <tr>
      <td><table width="100%" cellpadding="2">
        ...
        <tr>
          ...
          <td><input type="text" name="cccvv" value="{$cccvv}" size="5" /> <a href="#" onclick="window.open('images/ccv.gif','','width=280,height=200,scrollbars=no,top=100,left=100');return false">{$LANG.creditcardcvvwhere}</a></td>
        </tr>
        {if $shownostore}
        <tr>
