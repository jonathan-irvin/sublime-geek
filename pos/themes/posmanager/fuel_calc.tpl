...
<!--[include file='header.tpl']-->
  ...
  <div>
    <table class="mcenter tracktable txtleft" style="font-size: 12px;border-collapse:collapse;">
      <tr>
        <td>POS To refuel</td>
        <td><!--[html_options options=$opttowers name='pos_to_refuel' selected=$pos_to_refuel]--></td>
      </tr>
      <tr>
        <td>X Days Y hour(s) worth of fuel</td>
        <td><input type="text" name="days" size="2" value="<!--[$days_to_refuel]-->" /> days <input type="text" name="hours" size="2" value="<!--[$hours]-->" /> hours</td>
      </tr>
      <tr>
        <td>Use Current Level</td>
        <td>
      ...
      <tr>
        <td>Use Corporate hangar level</td>
        <td>
  ...
  <div>
    <table class="mcenter tracktable txtleft" style="margin-top:30px;width:460px;font-size: 12px;border-collapse:collapse;">
      ...
      <tr>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$total_required]--></td>
        <td><!--[formatnumber value=$fuel.needed_uranium]--></td>
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_uranium_size]--></td>
      </tr>
      <tr>
        <td>Oxygen</td>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_oxygen_size]--></td>
      </tr>
      <tr>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_mechanical_parts_size]--></td>
      </tr>
      <tr>
        <td>Coolant</td>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_coolant_size]--></td>
      </tr>
      <tr>
        <td>Robotics</td>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_robotics_size]--></td>
      </tr>
      <tr>
        <td>Isotopes</td>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_isotopes_size]--></td>
      </tr>
      <tr>
        <td>Liquid Ozone</td>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_ozone_size]--></td>
      </tr>
      <tr>
        <td>Heavy Water</td>
        ...
        <td style="color:#aaaaaa;"><!--[formatnumber value=$fuel.needed_heavy_water_size]--></td>
      </tr>
      <tr>
        <td>Total Size</td>
