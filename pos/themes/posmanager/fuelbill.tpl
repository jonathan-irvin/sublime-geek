...
<!--[include file='header.tpl']-->
  ...
  <h3 class="txtcenter" style="color:#aaaaaa;"><!--[$days_to_refuel]--> Days Fuel bill</h3>
  <form style="text-align: center;" method="post" action="fuelbill.php">
  <p style="text-align:center;">
    <span style="color:#aaaaaa;">Days <input name="days_to_refuel" size="5" value="<!--[$days_to_refuel]-->" type="text" /></span>
  ...
  <table cellspacing="0" class="mcenter" style="width:90%; padding:5px; font:11px Arial, sans-serif;">
    <tr style="background-color:#4F0202;">
      ...
      <td class="arialwhite12 billheader">Uranium</td>
      <td class="arialwhite12 billheader">Ozone</td>
  ...
  <!--[/if]-->
    <tr<!--[if $pos.pos_status eq 1]--> style="background-color:red;"<!--[/if]-->>
      ...
      <td class="billcontent"><a style="color:white;" href="viewpos.php?i=<!--[$pos.pos_id]-->" title="<!--[$pos.locationName]-->"><!--[$pos.locationName]--></a></td>
  ...
  <!--[/foreach]-->
    ...
    <tr>
      <td class="billcontent" colspan="4" style="text-align:left;">Total m3</td>
    ...
    <tr>
      <td style="background-color:#4F0202;text-align:left;" class="billcontent" colspan="4">Totals</td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_H_isotopes]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_N_isotopes]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_O_isotopes]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_Hy_isotopes]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_oxygen]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_mechanical_parts]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_coolant]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_robotics]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_uranium]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_ozone]--></td>
      <td style="background-color:#4F0202;" class="billcontent"><!--[formatnumber value=$fuel_heavy_water]--></td>
      <td class="arialwhite12">&nbsp;</td>
    </tr>
    <tr>
...
Mech Parts: <!--[formatnumber value=$fuel_mechanical_parts]--> (<!--[formatnumber value=$fuel_mechanical_parts_size]-->m3)
...
Uranium: <!--[formatnumber value=$fuel_uranium]--> (<!--[formatnumber value=$fuel_uranium_size]-->m3)
L-Ozone: <!--[formatnumber value=$fuel_ozone]--> (<!--[formatnumber value=$fuel_ozone_size]-->m3)
H-Water: <!--[formatnumber value=$fuel_heavy_water]--> (<!--[formatnumber value=$fuel_heavy_water_size]-->m3)
