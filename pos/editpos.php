 ...
 * @version    SVN: $Id: editpos.php 243 2009-04-26 16:10:33Z stephenmg $
...
//echo 'Change Tower Information - ' . $newstatus . ' - ' .$new_tower_name;exit;
        ...
        if ($posmgmt->ChangeTowerInfo(array('pos_id' => $pos_id, 'newstatus' => $newstatus, 'new_tower_name' => $new_tower_name, 'new_outpost'=>$new_outpost_id))) {
...
if ($tower) {
    ...
    $sovereignty              = $tower['sovereigntyLevel'] = $sov['sovereigntyLevel'];
    $tower['sovfriendly']     = (($allianceid == $sov['allianceID']) ? true : false);
...
$db = $posmgmt->selectstaticdb($sovereignty, $systemID, $allianceid);
...
$tower['optimum_ozone']            = ceil(($current_pg / $total_pg) * $required_ozone) * $optimum_cycles;
$tower['optimum_heavy_water']      = ceil(($current_cpu / $total_cpu) * $required_heavy_water) * $optimum_cycles;
