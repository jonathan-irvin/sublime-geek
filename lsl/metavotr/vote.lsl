...
integer Y;
integer Z;
list user = ["Hate it!","Crappy.","I Dunno...","It's Okay","Awesome!!","Support","ViewScores","Get One!","Feedback","Update"];
...
wave(){
    if ((!allow_drop)) {
        llSetLinkPrimitiveParams(6,[PRIM_FULLBRIGHT,ALL_SIDES,TRUE,PRIM_GLOW,ALL_SIDES,0.15,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,1.0]);
        llSetLinkPrimitiveParams(5,[PRIM_FULLBRIGHT,ALL_SIDES,TRUE,PRIM_GLOW,ALL_SIDES,0.15,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,1.0]);
        llSetLinkPrimitiveParams(4,[PRIM_FULLBRIGHT,ALL_SIDES,TRUE,PRIM_GLOW,ALL_SIDES,0.3,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,1.0]);
        llSetLinkPrimitiveParams(3,[PRIM_FULLBRIGHT,ALL_SIDES,TRUE,PRIM_GLOW,ALL_SIDES,0.15,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,1.0]);
        llSetLinkPrimitiveParams(2,[PRIM_FULLBRIGHT,ALL_SIDES,TRUE,PRIM_GLOW,ALL_SIDES,0.3,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,1.0]);
        llSetLinkPrimitiveParams(6,[PRIM_FULLBRIGHT,ALL_SIDES,FALSE,PRIM_GLOW,ALL_SIDES,0.0,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,0.5]);
        llSetLinkPrimitiveParams(5,[PRIM_FULLBRIGHT,ALL_SIDES,FALSE,PRIM_GLOW,ALL_SIDES,0.0,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,0.5]);
        llSetLinkPrimitiveParams(4,[PRIM_FULLBRIGHT,ALL_SIDES,FALSE,PRIM_GLOW,ALL_SIDES,0.0,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,0.5]);
        llSetLinkPrimitiveParams(3,[PRIM_FULLBRIGHT,ALL_SIDES,FALSE,PRIM_GLOW,ALL_SIDES,0.0,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,0.5]);
        llSetLinkPrimitiveParams(2,[PRIM_FULLBRIGHT,ALL_SIDES,FALSE,PRIM_GLOW,ALL_SIDES,0.0,PRIM_COLOR,ALL_SIDES,<0,0.6,0.75>,0.5]);
    }
}
getperms(integer perms){
    if ((perms && PERMISSION_DEBIT)) {
        ...
        llOwnerSay("Please select YES to continue.  This is for the vote push feature.");
    }
}
check_threadmap(){
