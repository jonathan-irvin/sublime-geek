// LSL script generated: livemark_pad.lslp Thu Nov 11 10:44:12 CST 2010
//LiveMark Update Pad
...
updateloc(){
    locinfo();
    if (DEBUG) {
        llOwnerSay(((((((((((((((((("slurl=" + llEscapeURL(internalurl())) + "&exurl=") + llEscapeURL(externalurl())) + "&pdesc=") + llEscapeURL(PDesc)) + "&parea=") + llEscapeURL(((string)PArea))) + "&locname=") + llEscapeURL(PName)) + "&profname=") + llEscapeURL(locName)) + "&profid=") + llEscapeURL(locURLid)) + "&puuid=") + llEscapeURL(PUuid)) + "&landpic=") + llEscapeURL(landpic)));
    }
    (landid = llHTTPRequest(("http://world.secondlife.com/place/" + ((string)PUuid)),[],""));
    (requestid = llHTTPRequest("http://lmrk.in/backend/update/",[0,"POST",1,"application/x-www-form-urlencoded"],((((((((((((((((("slurl=" + llEscapeURL(internalurl())) + "&exurl=") + llEscapeURL(externalurl())) + "&pdesc=") + llEscapeURL(PDesc)) + "&parea=") + llEscapeURL(((string)PArea))) + "&locname=") + llEscapeURL(PName)) + "&profname=") + llEscapeURL(locName)) + "&profid=") + llEscapeURL(locURLid)) + "&puuid=") + llEscapeURL(PUuid)) + "&landpic=") + llEscapeURL(landpic))));
}
//----------------------------------------------------------------------------//
        ...
        if ((chan == (-851095))) {
            ...
            if ((msg == "Update")) {
                if ((locURLid != "@")) {
                    ...
                    llOwnerSay("Error: Location hasn't been setup yet, please choose Setup");
                }
                llListenRemove(admchanhandle);
                return;
            }
    ...
    listen(integer chan,string name,key id,string msg) {
        if ((id == llGetOwner())) {
            ...
            if (((recv_name != "") || (profile != ""))) {
                llSetObjectDesc(((llStringTrim(name,STRING_TRIM) + "::") + llStringTrim(profile,STRING_TRIM)));
                llOwnerSay("Updated!");
