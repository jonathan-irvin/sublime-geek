...
(`id`,`voter_name`,`voter_key`,`owner_key`,`simname`,`locname`,`locurl`,`rating`,`timestamp`)
VALUES
(NULL,'$votername','$voterkey','$ownerKey','$simname','$locname','$slurl','$rating',CURRENT_TIMESTAMP)";
